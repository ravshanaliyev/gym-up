...
const Services = () => {
    return (
        <div className="h-full py-6 lg:py-0  lg:h-[800px] flex flex-col justify-center" style={{ backgroundImage: 'url("https://themewagon.github.io/fitnessclub/assets/img/gallery/section_bg01.png")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
