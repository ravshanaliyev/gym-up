...
const Offer = () => {
    return (
        <div className="h-[350px] my-16" style={{ backgroundImage: 'url("https://themewagon.github.io/fitnessclub/assets/img/gallery/section_bg02.png")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
