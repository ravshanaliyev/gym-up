...
const AdminProfile = () => {
    return (
        <div>
            ...
            <div className="relative h-[600px] my-4 bg-white">
                <img className="w-full h-[250px]" src="http://localhost:5174/src/images/cover/cover-01.png" alt="" />
                <div className="absolute top-3/3 left-1/2 transform backdrop-blur rounded-full p-3 -translate-x-1/2 -translate-y-1/2">
                    <img className="w-40 backdrop-blur " src="http://localhost:5174/src/images/user/user-06.png" alt="" />
                </div>
                <div className="flex flex-col items-center mt-24 w-[700px] mx-auto">
                    ...
                    <p className="text-base text-muted-foreground">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque posuere fermentum urna, eu condimentum mauris tempus ut. Donec fermentum blandit aliquet. Etiam dictum dapibus ultricies. Sed vel aliquet libero.</p>
                </div>
            </div>
        </div>
    )
